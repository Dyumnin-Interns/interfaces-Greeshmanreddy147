...
class tb:
    ...
    def con(self):
        ...
        self.s.addConstraint( lambda rd_en,rd_rdy,wd_en: rd_en == 1 if  wd_en == 0 else rd_en == 0 ,['read_en','read_rdy','write_en'])
        self.s.addConstraint( lambda rd_en,wd_rdy,wd_en: wd_en == 1 if  rd_en == 0 else rd_en == 0 ,['read_en','write_rdy','write_en'])
